...
import { selectDarkmode, setDarkmode } from '../features/auth/authSlice';
...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-thumb': {
    backgroundColor: theme.palette.mode === 'dark' ? '#90caf9' : '#0b345d',
    width: 24,
    height: 24,
    '&:before': {
      content: "''",
...
const DarkModeSwitch = () => {
  ...
  useEffect(() => {
    const dm = localStorage.getItem('darkmode') ?? 'false';
