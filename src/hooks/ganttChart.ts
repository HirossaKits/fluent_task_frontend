...
import { TASK, CALENDAR_BAR, CALENDAR_YEAR_MONTH, CALENDAR_DATE, CALENDAR_BAR_STYLE, PROJECT,GANTTCHART_BAR } from "../features/types";
import {parseDate} from '../util/dateHandler';

export const useCreateGanttChartBar = () => {
  return useCallback(( project: PROJECT,tasks: TASK[], barStyle: CALENDAR_BAR_STYLE): GANTTCHART_BAR[] => {
    ...
    // ガントチャートのバー 
    const ganttChartBars: GANTTCHART_BAR[] = sortedTasks.map((task) => {
